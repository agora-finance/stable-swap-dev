...
contract AgoraCompoundingOracle is AgoraStableSwapAccessControl {
    ...
    bytes32 public constant AGORA_COMPOUNDING_ORACLE_STORAGE_SLOT = 0xe8ff8c05fe4db6c989cd24f41a6017bb61bb3732b98d5e32412555322ce7a800;
    ...
    function _getPointerToAgoraCompoundingOracleStorage() internal pure returns (AgoraCompoundingOracleStorage storage $) {
    ...
    function configurePrice(uint256 _basePrice, uint256 _annualizedInterestRate) external {
        ...
        _getPointerToAgoraCompoundingOracleStorage().perSecondInterestRate = (_annualizedInterestRate / 365 days).toUint112();
    ...
    function getCompoundingPrice(uint256 _lastUpdated, uint256 _currentTimestamp, uint256 _interestRate, uint256 _basePrice ) public pure returns (uint256 _currentPrice) {
    ...
    function getPrice() public view virtual returns (uint256 _currentPrice) {
        ...
        _currentPrice = getCompoundingPrice({ _lastUpdated: _lastUpdated, _currentTimestamp: _currentTimestamp, _interestRate: _interestRate, _basePrice: _basePrice });
    }
}
